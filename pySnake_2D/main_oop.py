...
# Class Snake (Cap!)
class Snake():
    def __init__(self, field, # field - object of class Field() 
                    head=(0, 0), # head coordinates 
                    length = 1, speed = 5, # snake parameters
                    eat_sound = 'pySnake_2D/eat.mp3'): # eat_sound (Cap!)
        super().__init__()
...
class Field():
    def __init__(self, score = 0,  
                        ...
                        W = 30, H = 20): #number of squares Widht + Height
        ...
        if A or B or C:
            ...
            while game_over:
                ...
                render_reset = self.font_score.render(
                        'Press "Enter" to try again!', 1, pygame.Color('orange'))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_SPACE:
                    ...
                    if self.pause:
                        render_pause = self.font_gameover.render('P A U S E', 1,
                                    pygame.Color('orange'))
